...
class Sel4Label(IntEnum):
    ...
    X86PDPTUnmap = 70
    # X86 Page Directory
    X86PageDirectoryMap = 71
    X86PageDirectoryUnmap = 72
    X86PageDirectoryGetStatusBits = 73
    # X86 Page Table
    X86PageTableMap = 74
    X86PageTableUnmap = 75
    # X86 IO Page
    X86IOPageTableMap = 76
    X86IOPageTableUnmap = 77
    # X86 Page
    X86PageMap = 78
    X86PageUnmap = 79
    X86PageMapIO = 80
    X86PageGetAddress = 81
    X86PageMapEPT = 82
    # X86 ASID
    X86ASIDControlMakePool = 83
    # X86 ASID Pool
    X86ASIDPoolAssign = 84
    # X86 IO Port Control
    X86IOPortControlIssue = 85
    # X86 IO PORT
    X86IOPortIn8 = 86
    X86IOPortIn16 = 87
    X86IOPortIn32 = 88
    ...
    X86IOPortOut32 = 91
    # X86 IRQ
    X86IRQIssueIRQHandlerIOAPIC = 92
    X86IRQIssueIRQHandlerMSI = 93
    # X86 TCB
    TCBSetEPTRoot = 94
    # X86 VCPU
    X86VCPUSetTCB = 95
    X86VCPUReadVMCS = 96
    X86VCPUWriteVMCS = 97
    X86VCPUEnableIOPort = 98
    X86VCPUDisableIOPort = 99
    X86VCPUWriteRegisters = 100
    # X86 EPTPDPT
    X86EPTPDPTMap = 101
    X86EPTPDPTUnmap = 102
    # X86 EPTPD
